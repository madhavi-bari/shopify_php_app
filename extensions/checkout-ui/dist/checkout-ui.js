...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    ...
    const [cities, setCities] = (0, import_react12.useState)([]);
    const [selectedCity, setSelectedCity] = (0, import_react12.useState)("");
    ...
    const fetchCitiesByCountry = (countryCode2) => __async(this, null, function* () {
      try {
        const response = yield fetch(`https://proptrend.hostingduty.com/proptrends_api/TestApi/cities.php?country_code=${countryCode2}`);
        if (!response.ok) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      Select2,
      {
        ...
        options: [
          { value: "", label: "Select" },
          ...cities.map((city2) => ({ value: city2, label: city2 }))
        ],
